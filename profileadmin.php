...
<body class="d-flex flex-column min-vh-100">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <div class="d-flex justify-content-start">
                    <div class="images-thumbnail" style="width: 100px;">
                        <img src="<?= !empty($user_data['foto']) ? 'images/' . htmlspecialchars($user_data['foto']) : 'images/default-profile.png' ?>"
    ...
    <footer id="footer" class="text-center p-5 bg-danger-subtle mt-auto">
        <div>
            <a href="https://www.instagram.com/y_dhizz?igsh=MW9rY2gzZGh0anJ3cg==" class="h2 p-2 text-dark"><i
                    class="bi bi-instagram"></i></a>
            <a href="https://www.twitter.com" class="h2 p-2 text-dark"><i class="bi bi-twitter"></i></a>
            <a href="https://wa.me/qr/N43UOYYW3V75G1" class="h2 p-2 text-dark"><i class="bi bi-whatsapp"></i></a>
            <a href="https://www.tiktok.com/@dhizz_notyourtype?_t=ZS-8sx7WgB1Sdz&_r=1" class="h2 p-2 text-dark"><i
                    class="bi bi-tiktok"></i></a>
        </div>
        <div>Yudhistira Mahendra Herianto &copy; 2024</div>
    </footer>
    <!-- footer end -->
